...
use xenialdan\SignEditor\subcommand\CancelSubCommand;
use xenialdan\SignEditor\subcommand\EditSubCommand;
use xenialdan\SignEditor\subcommand\SubCommand;
...
class Commands extends PluginCommand{
	...
	public function __construct(Plugin $plugin){
		parent::__construct("signeditor", $plugin);
		$this->setAliases(["se"]);
		$this->setPermission("signeditor.command");
		$this->setDescription("The main commands for signeditor");
	...
	public function execute(CommandSender $sender, string $commandLabel, array $args){
		...
		if ($canUse){
			if (!$command->execute($sender, $args)){
				$sender->sendMessage(TextFormat::YELLOW . "Usage: /signeditor " . $command->getName() . TextFormat::BOLD . TextFormat::DARK_AQUA . " > " . TextFormat::RESET . TextFormat::YELLOW . $command->getUsage());
			}
	...
	private function sendHelp(CommandSender $sender){
		$sender->sendMessage("===========[signeditor commands]===========");
		foreach ($this->commandObjects as $command){
			if ($command->canUse($sender)){
				$sender->sendMessage(TextFormat::DARK_GREEN . "/signeditor " . $command->getName() . TextFormat::BOLD . TextFormat::DARK_AQUA . " > " . TextFormat::RESET . TextFormat::DARK_GREEN . $command->getUsage() . ": " .
